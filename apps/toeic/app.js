...
function makeQuestion(part,i,seed=0){
 ...
 if(part===3){const loc=['office','hotel','warehouse','airport'];const place=loc[(i+seed)%loc.length];return{id:tag,part:3,skill:'Conversation detail',stimulus:`M: The delivery for the ${place} will arrive at 3 p.m.\nW: Great. I’ll ask the front desk to call us when it arrives.\nM: Please check the item count before signing the form.`,q:'What does the man ask the woman to do?',['Check the item count','Change the delivery date','Call a customer','Reserve a hotel'],answer:0,explain:'He asks her to check the item count.'}}
 if(part===4){return{id:tag,part:4,skill:'Announcement purpose',stimulus:`Good morning. This is a reminder that the employee workshop will begin at 10 a.m. in Room ${100+(i%5)}. Please bring your identification card and arrive ten minutes early.`,q:'What is the purpose of the announcement?',['To remind employees about a workshop','To advertise a new product','To cancel a reservation','To announce a store closing'],answer:0,explain:'It reminds employees about the workshop.'}}
